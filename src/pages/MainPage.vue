<template>
  ...
  <n-button v-if="isAdmin" @click="showModal = true" @close="showModal.value = false;" class="button__add" type="warning">Добавить новый товар</n-button>
  <AddProduct v-if="showModal" /> 
    <MyCardList />
